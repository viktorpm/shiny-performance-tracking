...
drive_download(
  file = "Water Log",
  path = file.path("training_and_watering_visual", "Water Log.xlsx"),
  overwrite = T
)

rio::convert(
  in_file = file.path("training_and_watering_visual", "Water Log.xlsx"),
  out_file = file.path("training_and_watering_visual", "Water Log.csv"))
...
```{r}
water <- openxlsx::read.xlsx(file.path("training_and_watering_visual", "Water Log.xlsx"))
```
