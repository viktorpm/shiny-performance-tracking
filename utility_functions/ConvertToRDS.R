...
# - save_path: The path where the converted .rds file will be saved.
#   If not provided, a default path is used.
# - filename_pos: The position of the last "/" in the file path,
...
# - rat_data: The data read from the .mat file using R.matlab's
#   readMat function.
